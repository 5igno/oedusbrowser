function handles = UpdateSelectorsAndSpectrum(handles)

% Change selector visibility and range of depending on the targeted spectrum
[UIctrl_out] = UpdateSelectors( handles.target, handles.data_type , handles.id_data_list, ...
...
handles.selected_data = UpdateSelectedSpectrum( handles.target, handles.data_type , ...
    handles.id_data_list, handles.id_stress, handles.id_measurement);

% handles.has_roi = isfield(handles.selected_data,'ROI');
